...
<div align="center">
<h2>CosmicComics Web Client</h2>
  This project is part of <a href="https://github.com/Nytuo/CosmicComics">CosmicComics</a>
  <br />
  <br />
  <a href="https://github.com/NytuoIndustries/CosmicComicsWebClient/issues/new?assignees=&labels=bug&template=01_BUG_REPORT.md&title=bug%3A+">Report a Bug</a>
  ·
  <a href="https://github.com/NytuoIndustries/CosmicComicsWebClient/issues/new?assignees=&labels=enhancement&template=02_FEATURE_REQUEST.md&title=feat%3A+">Request a Feature</a>
...
[![Project license](https://img.shields.io/github/license/NytuoIndustries/CosmicComicsWebClient.svg?style=flat-square)](LICENSE)
...
- [CosmicComics React Client](https://github.com/NytuoIndustries/CosmicComicsWebClient) (Interface)
...
An instance of a CosmicComics Server ([CosmicComics Node Server](NytuoIndustries/CosmicComicsNodeServer))
...
See the [open issues](https://github.com/NytuoIndustries/CosmicComicsWebClient/issues) for a list of proposed features (and known issues).

- [Top Feature Requests](https://github.com/NytuoIndustries/CosmicComicsWebClient/issues?q=label%3Aenhancement+is%3Aopen+sort%3Areactions-%2B1-desc) (Add your votes using the 👍 reaction)
- [Top Bugs](https://github.com/NytuoIndustries/CosmicComicsWebClient/issues?q=is%3Aissue+is%3Aopen+label%3Abug+sort%3Areactions-%2B1-desc) (Add your votes using the 👍 reaction)
- [Newest Bugs](https://github.com/NytuoIndustries/CosmicComicsWebClient/issues?q=is%3Aopen+is%3Aissue+label%3Abug)
...
For a full list of all authors and contributors, see [the contributors page](https://github.com/NytuoIndustries/CosmicComicsWebClient/contributors).
